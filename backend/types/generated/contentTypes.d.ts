...
export interface ApiArtistArtist extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'artists';
    displayName: 'Artist';
    description: 'Artists roster for the record label';
  };
  options: {
  ...
  attributes: {
    ...
    social: Attribute.Component<'social.links'>;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'products';
    displayName: 'Product';
    description: 'Shop products (merchandise and releases)';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    name: Attribute.String & Attribute.Required;
    category: Attribute.Enumeration<['vinyl', 'cd', 'merch']> &
      Attribute.Required;
...
export interface ApiReleaseRelease extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'releases';
    displayName: 'Release';
    description: 'Music releases (albums, EPs, singles)';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    coverArt: Attribute.Media<'images'> & Attribute.Required;
    type: Attribute.Enumeration<['album', 'ep', 'single']> & Attribute.Required;
    tracks: Attribute.Component<'music.track', true>;
    streamingLinks: Attribute.Component<'music.streaming-links'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
